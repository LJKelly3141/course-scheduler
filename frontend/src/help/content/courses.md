...
Click **+ Add Course** at the top. Fill in:
...
Expand any course row (click the arrow) to see its sections for the selected term.

### Add a Section

Click **+ Add Section** under the expanded course. Fill in:
