...
> **Tip:** For department-wide reassignment planning across semesters, use the **Reassignment Plan** page under **Planning** in the sidebar. It lets you define recurring patterns and apply them to new terms automatically.
